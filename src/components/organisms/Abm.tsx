        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            <List className='flex gap-4'>
              <Item>
                <button className='flex gap-2 items-center flex-wrap p-2 px-4 text-white bg-primary-green rounded-md'><PlusIcon /><p className='flex text-start flex-col'> Nuevo <span className=''>{table.split('_').join(' ')}</span></p>
                </button>
              </Item>
              <Item>
                <button className='flex gap-2 px-4 items-center flex-wrap p-2 text-white bg-primary-green rounded-md'>
                  <ModificateIcon /> <p className='flex text-start flex-col'>Modificar <span className=''>{table.split('_').join(' ')}</span></p>
                </button>
              </Item>
            </List>
          </AlertDialogHeader>
